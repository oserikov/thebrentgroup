...
import { CREDIBILITY } from "../content.generated";

export default function CredibilityPage() {
  const [line1] = CREDIBILITY.heroTitle;

  return (
    <div className="bg-white min-h-screen flex flex-col">
      <div className="bg-[#f7f7f7]">
        <Nav current="credibility" />
      ...
      <div className="max-w-[1440px] w-full mx-auto px-6 lg:px-20">
        <section className="max-w-[700px] mx-auto flex flex-col gap-16 pb-24 pt-16">
          <div className="flex flex-col gap-6">
            <h2 className="font-space font-medium text-[24px] text-black">
              {CREDIBILITY.rogerHeading}
            </h2>
            <div
              className="md-content font-space font-light text-[16px] leading-[20px] text-black"
              dangerouslySetInnerHTML={{ __html: CREDIBILITY.rogerHtml }}
            />
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div
              className="md-content font-space font-light text-[16px] leading-[20px] text-black"
              dangerouslySetInnerHTML={{ __html: CREDIBILITY.bodyHtml }}
            />
          </div>
        </section>
      </div>
